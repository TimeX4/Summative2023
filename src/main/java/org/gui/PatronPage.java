...
public class PatronPage {
    ...
    /**
     * Prints an item out as a fancy string, used to display due dates and other information the
     * patron may need.
     *
     * @param id The id of the item being displayed.
     * @return A fancy string of the item.
     */
    public String fancyString(long id) {
        Item item = null;
        String string = "ERROR";
        String unique = "";
        ...
        LocalDate value = patron.getCheckedOut().get(id);
        LocalDate due = value.plusDays(item.getMaxCheckoutDays());
        string = item.getTitle() + ", " + unique + " | Due: " + due;
        return string;
    }
    ...
    private <E> void CheckInItem(HashMap<Long, E> map) {
        ...
        for (Map.Entry<Long, E> entry : map.entrySet()) {
            ...
            if (i == idx) {
                ...
                notificationText.showText("Amount due: $" + due + "0.", 2000);
            }
            i++;
        }
    }
    ...
    private <E> void setModelMap(Set<Map.Entry<Long, E>> entrySet) {
        ...
        for (Map.Entry<Long, E> entry : entrySet) {
            ...
            if (item != null) {
                listModel.addElement(fancyString(((Item) item).getID()));
            }
        }
    ...
    private void $$$setupUI$$$() {
        ...
        Panel.add(ButtonPanel, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        Back = new JButton();
        Back.setText("Logout");
        ButtonPanel.add(Back, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        CheckIn = new JButton();
        CheckIn.setText("Check In");
        ButtonPanel.add(CheckIn, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ViewAll = new JButton();
        ViewAll.setText("View Library");
        ButtonPanel.add(ViewAll, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        HeaderPanel = new JPanel();
        HeaderPanel.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), -1, -1));
        Panel.add(HeaderPanel, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        Title = new JLabel();
        Font TitleFont = this.$$$getFont$$$("Arial Narrow", -1, 20, Title.getFont());
        if (TitleFont != null) Title.setFont(TitleFont);
        Title.setText("Checked Out");
        HeaderPanel.add(Title, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ListScroller = new JScrollPane();
        Panel.add(ListScroller, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
        ItemList = new JList();
