...
public class AllItems {
     ...
     * active item list. Checks the item back in for all Patrons with it checked out.
     *
    ...
    private <E> void deleteItem(long id, int idx, HashMap<Long, E> loadedItems) {
        Item item = (Item) loadedItems.get(id);
        if (item == null) {
            notificationText.showText("ERROR: Item not found.", 3000);
            return;
        }
        if (!item.getCheckOuts().isEmpty()) {
            notificationText.showText("Cannot delete item, copies are still checked out.", 3000);
            return;
        }
    ...
    private void $$$setupUI$$$() {
        ...
        Panel.add(typeCombo, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        searchBar = new JTextField();
        Panel.add(searchBar, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
